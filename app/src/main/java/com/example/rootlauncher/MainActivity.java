...
public class MainActivity extends AppCompatActivity {
    ...
    /* 
     * BusyBox 必须叫 busybox。
     * 不要改成：/data/local/tmp/root_launcher_busybox
     * 因为 BusyBox 会根据 argv[0] / basename 判断要运行哪个 applet。
     */
    ...
    // 静默提取 BusyBox，只在发生致命错误时返回 false
    private boolean extractAndPrepareBusybox() {
        try {
            ...
            // 强制使用 /data/local/tmp/busybox，这是最安全的路径
